...
4. **Curate.** A human BI domain expert reviewed **178 explanations
   (25% of the dataset)** and **hand-edited 30** of them, concentrating
...
| Split | Rows | Purpose |
|---|---|---|
| `train` | 611 | Fine-tuning. |
| `heldout` | 100 | Base-vs-finetuned evaluation (LLM-as-judge). |

## Category balance

| Category | Train | Held-out | Total |
|---|---|---|---|
| `simple_aggregation` | 111 | 11 | 122 |
| `time_intelligence` | 73 | 16 | 89 |
| `ratio` | 104 | 22 | 126 |
| `iterator` | 108 | 18 | 126 |
| `ranking` | 116 | 16 | 132 |
| `filter_context` | 99 | 17 | 116 |
| **All** | **611** | **100** | **711** |
